  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to World Trivia Journey, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to World Trivia Journey.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: klordbravo@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://kingsleyamoke.com.ng"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://kingsleyamoke.com.ng
            </a>
          </p>
        </li>
      </ul>
